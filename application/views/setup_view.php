                ...
                <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 form-box">
                    <form role="form" action="<?php echo base_url() ?>setup/submit" method="post" class="f1">
                        ...
                        <fieldset>
                            ...
                            <p>
                                &emsp;Silahkan memulai dengan mengisi
                                data perusahaan anda. Terimakasih.
                            </p>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" placeholder="Nama Perpustakaan"
                                    class="f1-first-name form-control" id="f1-first-name">
                            </div>
                            <div class="form-group">
                                <label class="sr-only">Alamat</label>
                                <input type="text" name="address" placeholder="Alamat" class="f1-last-name form-control"
                                    id="f1-last-name">
                            </div>
                            <div class="form-group">
                                <label class="sr-only">Tentang</label>
                                <textarea name="about" placeholder="Tentang" class="f1-about-yourself form-control"
                                    id="f1-about-yourself"></textarea>
                            </div>
                            <div class="f1-buttons">
